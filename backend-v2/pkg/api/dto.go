...
type ConsensusStats struct {
	...
	LastCommittedHeight uint64 `json:"last_committed_height,omitempty"`
	ReplayWindowSize    int    `json:"replay_window_size,omitempty"`
	MetadataHeight      int64  `json:"metadata_height,omitempty"`
	HeightDrift         int64  `json:"height_drift,omitempty"`

	RestoreDroppedProposalsStale int `json:"restore_dropped_proposals_stale,omitempty"`
	RestoreDroppedProposalsAhead int `json:"restore_dropped_proposals_ahead,omitempty"`
	RestoreDroppedVotesStale     int `json:"restore_dropped_votes_stale,omitempty"`
	RestoreDroppedVotesAhead     int `json:"restore_dropped_votes_ahead,omitempty"`
	RestoreDroppedQCsStale       int `json:"restore_dropped_qcs_stale,omitempty"`
	RestoreDroppedQCsAhead       int `json:"restore_dropped_qcs_ahead,omitempty"`
	RestoreDroppedEvidenceStale  int `json:"restore_dropped_evidence_stale,omitempty"`
	RestoreDroppedEvidenceAhead  int `json:"restore_dropped_evidence_ahead,omitempty"`

	MetadataRepairLastUnix int64  `json:"metadata_repair_last_unix,omitempty"`
	MetadataRepairError    string `json:"metadata_repair_error,omitempty"`
}
