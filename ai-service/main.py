...
Examples:
  ...
  python main.py --log-level DEBUG --log-file service.log
    ...
    # Use project root .env (parent of ai-service directory)
    default_config = Path(__file__).resolve().parent.parent / ".env"
...
def main():
    ...
    # PID file path
    pid_file = Path(__file__).parent / "data" / "service.pid"
