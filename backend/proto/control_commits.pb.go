...
// 	protoc        v6.32.1
// source: proto/control_commits.proto
...
type CommitEvent struct {
	...
	// Individual transaction tracking (Fix: Gap 2 - enable COMMITTED state)
	AnomalyIds []string `protobuf:"bytes,13,rep,name=anomaly_ids,json=anomalyIds,proto3" json:"anomaly_ids,omitempty"` // List of committed anomaly UUIDs (UUIDv4 strings)
	// Timing
...
func (x *CommitEvent) Reset() {
	*x = CommitEvent{}
	mi := &file_proto_control_commits_proto_msgTypes[0]
...
func (*CommitEvent) Descriptor() ([]byte, []int) {
	return file_proto_control_commits_proto_rawDescGZIP(), []int{0}
}
...
func (x *CommitEvent) GetAnomalyIds() []string {
	if x != nil {
		return x.AnomalyIds
	}
	return nil
...
var File_proto_control_commits_proto protoreflect.FileDescriptor

const file_proto_control_commits_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/control_commits.proto\x12\x14cybermesh.control.v1\"\x95\x03\n" +
	...
	"\fpolicy_count\x18\a \x01(\rR\vpolicyCount\x12\x1f\n" +
	"\vanomaly_ids\x18\r \x03(\tR\n" +
	"anomalyIds\x12\x1c\n" +
...
var (
	file_proto_control_commits_proto_rawDescOnce sync.Once
	file_proto_control_commits_proto_rawDescData []byte
)

func file_proto_control_commits_proto_rawDescGZIP() []byte {
	file_proto_control_commits_proto_rawDescOnce.Do(func() {
		file_proto_control_commits_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_control_commits_proto_rawDesc), len(file_proto_control_commits_proto_rawDesc)))
	})
	return file_proto_control_commits_proto_rawDescData
}

var file_proto_control_commits_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_control_commits_proto_goTypes = []any{
	(*CommitEvent)(nil), // 0: cybermesh.control.v1.CommitEvent
}
var file_proto_control_commits_proto_depIdxs = []int32{
...
func init() { file_proto_control_commits_proto_init() }
func file_proto_control_commits_proto_init() {
	if File_proto_control_commits_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_control_commits_proto_rawDesc), len(file_proto_control_commits_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_control_commits_proto_goTypes,
		DependencyIndexes: file_proto_control_commits_proto_depIdxs,
		MessageInfos:      file_proto_control_commits_proto_msgTypes,
	}.Build()
	File_proto_control_commits_proto = out.File
	file_proto_control_commits_proto_goTypes = nil
	file_proto_control_commits_proto_depIdxs = nil
}
